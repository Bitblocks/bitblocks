...
#ifndef _BITBLOCKRPC_H_
#define _BITBLOCKRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // BitBlock is not connected
...
/**
 * BitBlock RPC command dispatcher.
 */
class CRPCTable
{
private:
